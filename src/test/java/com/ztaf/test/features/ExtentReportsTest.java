...
public class ExtentReportsTest {
	...
	public void startReport() {
		...
		htmlReporter.config().setDocumentTitle("Title of the Report Comes here "); // Name of the report
		htmlReporter.config().setReportName("Name of the Report Comes here "); // Dark Theme
